...
tsne_seurat_object <- RunTSNE( seurat_object, reduction.use = opt$reduction_use, cells.use = cells_use, dims.use = dims_use, genes.use = NULL, do.fast = opt$do_fast, check_duplicates = FALSE)
